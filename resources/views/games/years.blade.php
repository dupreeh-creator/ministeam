                ...
                <div class="col-sm-3">
                    <div class="search_box pull-right">
                        <form action="searchGame" method="get">
                            <input type ='text' name="searchGame" placeholder="search"/>
                        </form>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <br>
                        <div class="brands_products"><!--brands_products-->
                            <h2>Game By Price Range</h2>
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="#"> <span class="pull-right">(50)</span>0$</a></li>
                                    <li><a href="#"> <span class="pull-right">(56)</span>1$-5$</a></li>
                                    <li><a href="#"> <span class="pull-right">(27)</span>5$-10$</a></li>
                                    <li><a href="#"> <span class="pull-right">(32)</span>10$-20$</a></li>
                                    <li><a href="#"> <span class="pull-right">(5)</span>20$-30$</a></li>
                ...
                <div class="col-sm-9 padding-right">
                    <div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content">
                        <div class="results">Showing <span>{{$yea->games->count()}}</span> games</div>
